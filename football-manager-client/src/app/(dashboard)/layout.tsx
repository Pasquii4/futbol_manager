...
export default function DashboardLayout({
    ...
    return (
        <div className="flex h-screen bg-neutral-100 dark:bg-neutral-900">
            {/* Sidebar */}
            <aside className="w-64 border-r border-neutral-200 dark:border-neutral-800 hidden md:block glass">
                <div className="p-6">
                ...
                <nav className="mt-6 px-4 space-y-2">
                    ...
                    <NavItem href="/alineacion" icon={<Users size={20} />} label="Alineación" />
            ...
            <main className="flex-1 overflow-y-auto">
                <header className="h-16 bg-white dark:bg-neutral-950 border-b border-neutral-200 dark:border-neutral-800 flex items-center justify-between px-8 glass">
